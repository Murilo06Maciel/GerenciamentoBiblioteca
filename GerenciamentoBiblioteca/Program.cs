...
class Program
{
    static void Main()
    {
        List<Livro> livros = new List<Livro>()
        {
            ...
            new Livro("Ulisses", "James Joyce", 1922, "Ficção, Modernismo", "A obra segue Leopold Bloom durante um único dia em Dublin, intercalando seus pensamentos e ações com a vida de outros personagens. Ulisses é conhecido por seu estilo inovador, que utiliza técnicas como o fluxo de consciência e a estrutura de episódios. A narrativa aborda temas de identidade, busca de significado e a banalidade do cotidiano.", 10),
            new Livro("Mrs. Dalloway", "Virginia Woolf", 1925, "Ficção, Modernismo", "A história segue Clarissa Dalloway, uma mulher que organiza uma festa em Londres após a Primeira Guerra Mundial. A narrativa revela os pensamentos e memórias de Clarissa e de outros personagens ao longo de um único dia. Woolf explora temas como a passagem do tempo, a saúde mental e as complexidades das relações humanas, utilizando o fluxo de consciência para transmitir as experiências internas de seus personagens.", 10),
            new Livro("Admirável Mundo Novo", "Aldous Huxley", 1932, "Ficção Científica, Distopia", "Ambientada em uma sociedade futurista onde a felicidade é imposta por meio de condicionamento e controle social, a narrativa segue Bernard Marx, que começa a questionar os valores de sua sociedade. A história explora temas de liberdade, individualidade e a desumanização causada pela tecnologia e pelo consumismo, levantando questões sobre o que significa ser verdadeiramente humano.", 10),
            new Livro("1984", "George Orwell", 1949, "Distopia, Ficção Científica", "A obra retrata um regime totalitário que controla a vida de seus cidadãos por meio de vigilância constante e manipulação da verdade. Winston Smith, o protagonista, trabalha para o Partido, mas começa a questionar a realidade em que vive. A narrativa aborda temas de opressão, controle mental e a luta pela liberdade, destacando os perigos do totalitarismo e da desinformação.", 10),
            new Livro("O Diário de Anne Frank", "Anne Frank", 1947, "Autobiografia, Memórias", "Este diário é o relato íntimo de Anne Frank, uma adolescente judia que se esconde com sua família durante a ocupação nazista na Segunda Guerra Mundial. Ao longo de suas anotações, Anne descreve sua vida cotidiana, seus pensamentos e sentimentos, suas esperanças e medos, além das tensões do esconderijo e da realidade do Holocausto. O diário se tornou um poderoso testemunho da resiliência humana e uma crítica ao ódio e à intolerância, simbolizando a luta pela liberdade e dignidade em face da opressão.", 10)
        };
        int escolha;
        int opcao = 0;
